<template>
  <div class="flex-1 border-r border-gray-100 flex flex-col overflow-y-auto">
    ...
    >
      ...
      <div><span class="font-bold">전용우</span> 님의 최근 트윗</div>
      <div class="text-gray-500">
        통영에서는 1932년에 건설된 동양 최초의 '해저터널'이 있습니다. 문화재 명칭은
        '통영해저턴절'이지만, 원이름은 '태합굴'이었습니다. 태합굴이라는 이름이 붙은 것은
        터널공사가 시작되기 훨씬 전인 1925년의 일입니다. '태합'은 토요토미 히데요시를
        말합니다.
      </div>
    </div>
  </div>
